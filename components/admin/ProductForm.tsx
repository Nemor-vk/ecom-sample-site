...
export function ProductForm() {
  ...
  async function onSubmit(values: z.infer<typeof productSchema>) {
    ...
    try {
      ...
      window.location.reload(); // REMOVE LATER
  ...
  useEffect(() => {
    ...
    async function getAllSections(){
      try {
          ...
          console.log("PRODUCT FORM :: promotional tags api response ", data.tags)
          const nameList:string[] = data.tags ? data.tags.map((tag:Section) => tag.name) : []
          console.log("PRODUCT FORM :: promotional tags api response name list ", nameList)
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-8 capitalize w-[450px] p-8 rounded-md border-2 "
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="OnePlus Nord Buds 2r"
                  type="text"
                  {...field}
                  required
                />
              ...
              <FormControl>
                <Select {...field} required>
                  ...
                  <SelectContent className="text-sm border-2">
                    <SelectItem value={PRODUCT_TYPE.PHYSICAL}>
                      {PRODUCT_TYPE.PHYSICAL}
                    </SelectItem>
                    <SelectItem value={PRODUCT_TYPE.DIGITAL}>
              ...
              <FormControl>
                <Select onValueChange={field.onChange}>
                  ...
                  <SelectContent className="text-sm border-2">
                    ...
                    <Link href="/admin/categories/new" className="w-full m-0 p-0">
