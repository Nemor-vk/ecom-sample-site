...
const SidePopupDrawer = () => {
  ...
  return (
     <div className={cn('w-max h-screen overflow-clip absolute top-0 right-0 transition-all duration-300 z-50 bg-card pb-2 pt-5', isOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 hidden")}>
